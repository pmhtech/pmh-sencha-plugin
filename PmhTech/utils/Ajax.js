Ext.define('PmhTech.utils.Ajax', {
    ...
    refreshAccessToken : function(response){


        var accessToken = PmhTech.Cookie.getAccessToken();
        ...
        PmhTech.Ajax.request({
            ...
            params : {
                ...
                PmhTech.Msg.alert('확인','로그인정보가 만료되어 로그인페이지로 이동합니다.',function(){
                    location.href="";
                });
    ...
    _runAjax: function (options) {
        ...
        if(accessToken){
            options.headers['Authorization']='Bearer '+ PmhTech.Cookie.getAccessToken();
        }
        options.cors=true;
