...
Ext.define('PmhTech.plugin.grid.Exporter', {
    ...
    init: function (grid) {
        ...
        me.grid.getDataValues = Ext.Function.bind(me.getDataValues,me);
    },
    getDataValues : function(fieldNames){
      var me = this;
      var result = [];
      var datas = Ext.Array.pluck(me.grid.getStore().data.items,'data');
